...
def test_provider(spark: SparkSession, sample_ratings_dataset: DataFrame, petastorm_cache_dir: str):
    ...
    non_partitioned_converter = provider.get_dataset_converter(sample_ratings_dataset, with_repartition=False)
